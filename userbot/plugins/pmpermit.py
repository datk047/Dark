...
import fridayuserbot.plugins.sql_helper.pmpermit_sql as pmpermit_sql
from fridayuserbot import ALIVE_NAME
from fridayuserbot import CUSTOM_PMPERMIT
...
if Var.PRIVATE_GROUP_ID is not None:
    ...
    async def on_new_private_message(event):
        ...
        if USER_BOT_NO_WARN == message_text:
            # fridayuserbot's should not reply to other fridayuserbot's
