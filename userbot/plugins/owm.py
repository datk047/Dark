...
from fridayfridayuserbot import OPEN_WEATHER_MAP_APPID as OWM_API
...
async def set_default_city(city):
    """ For .ctime command, change the default fridayfridayuserbot country for date and time commands. """
