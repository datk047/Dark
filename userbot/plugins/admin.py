...
from fridayfridayuserbot.utils import friday_on_cmd, errors_handler, register, sudo_cmd
...
async def spider(spdr):
    ...
    try:
        from fridayfridayuserbot.modules.sql_helper.spam_mute_sql import mute
...
async def unmoot(unmot):
    ...
    # Check if the function running under SQL mode
    try:
        from fridayfridayuserbot.modules.sql_helper.spam_mute_sql import unmute
    except AttributeError:
...
async def muter(moot):
    ...
    try:
        ...
        from fridayfridayuserbot.modules.sql_helper.spam_mute_sql import is_muted
    except AttributeError:
        return
...
async def ungmoot(un_gmute):
    """ For .ungmute command, ungmutes the target in the fridayfridayuserbot """
    # Admin or creator check
